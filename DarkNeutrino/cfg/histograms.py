...
def getHists(pfxs):
    ...
    for pfx in pfxs:
        ...
        h.book(pfx+'_ptMu',';p_{T}(MET,#mu) [GeV];',40,0,80)
        h.book(pfx+'_ptMuS',';p_{T}(MET,#mu) [GeV];',40,0,80)
        h.book(pfx+'_ptMuL',';p_{T}(MET_{lep},#mu) [GeV];',40,0,80)
        ...
        h.book(pfx+'_ptee',';p_{T}(e^{+},e^{-}) [GeV];',40,0,80)
        ...
        h.book(pfx+'_meeSup',';m(e^{+},e^{-}) [GeV];',40,0,4)
        h.book(pfx+'_meeSdn',';m(e^{+},e^{-}) [GeV];',40,0,4)
        ...
        h.bookBins(pfx+'_meeSup_logx1',';m(e^{+},e^{-}) [GeV];',bins)
        h.bookBins(pfx+'_meeSdn_logx1',';m(e^{+},e^{-}) [GeV];',bins)
        ...
        h.bookBins(pfx+'_meeSup_logx2',';m(e^{+},e^{-}) [GeV];',bins)
        h.bookBins(pfx+'_meeSdn_logx2',';m(e^{+},e^{-}) [GeV];',bins)
        h.bookBins(pfx+'_meeAdHoc_logx2',';m(e^{+},e^{-}) [GeV];',bins)
        h.book(pfx+'_mupt',';p_{T}(#mu) [GeV]',40,0,80)
        h.book(pfx+'_mueta',';#eta(#mu)',40,-4,4)
        h.book(pfx+'_met',';p_{T,miss} [GeV]',40,0,80)
        h.book(pfx+'_ht','; H_{T} [GeV]',40,0,400)
        h.book(pfx+'_htc','; Charged particle H_{T} [GeV]',40,0,400)
        ...
        h.book(pfx+'_e1eta',';#eta(e_{1})',40,-4,4)
        h.book(pfx+'_e2eta',';#eta(e_{2})',40,-4,4)
        ...
        h.book(pfx+'_dRLepMu',';dR(ll,#mu)',40,0,4)
